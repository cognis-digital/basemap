"""Native cognis-connect emit for basemap — forward findings to any platform.

Maps basemap's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    basemap ... --format json | basemap-emit --to stix
    basemap-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
